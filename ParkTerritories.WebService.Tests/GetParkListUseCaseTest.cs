    ...
    public class GetParkListUseCaseTest
    {
        private InMemoryParkRepository CreateRoteRepository()
        {
            var repo = new InMemoryParkRepository(new List<Park> {
                new Park { Id = 1,  Name = "Парк №1" , Water ="нет", Location ="на перекрёстке", PlayGround = PlayGrounds.no, SportsGround = SportsGrounds.yes},
                new Park { Id = 2,  Name = "новый парк" , Water ="нет", Location ="в жоке мира", PlayGround = PlayGrounds.yes, SportsGround = SportsGrounds.no},
                new Park { Id = 3,  Name = "маленький парк" , Water ="да", Location ="на перекрёстке", PlayGround = PlayGrounds.no, SportsGround = SportsGrounds.no},
                new Park { Id = 4,  Name = "Парк паркович" , Water ="нет", Location ="во дворах", PlayGround = PlayGrounds.yes, SportsGround = SportsGrounds.yes},
            });
            return repo;
        }
